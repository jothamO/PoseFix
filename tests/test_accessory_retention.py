...
def test_accessory_mismatch_retries_instead_of_passing():
    checks = {
    ...
    assert result["checks"]["accessory_fidelity"]["status"] == "fail"


def test_invented_accessory_retries_instead_of_passing():
    checks = {
        "identity_retention": 0.97,
        "pose_target_adherence": 0.94,
        "anatomical_plausibility": 0.97,
